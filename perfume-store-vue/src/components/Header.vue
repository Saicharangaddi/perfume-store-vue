                ...
                <!--Search Bar-->
                 <form class="w-full md:flex-1 max-w-sm" role="search" aria-label="Site search">
                   <label class="relative w-full">
                      ...
                      class="w-full px-3 py-2 text-xs border border-gray-300 rounded-full focus:outline none 
                      focus:ring-2 focus:ring-indigo-500">

                      <button type="submit"
                      class="absolute right-2 top-1/2 -translate-y-1/2 text-gray-500 hover:text-indigo600"
                 ...
                 <!--Icons-->
                  <aside class="flex items-center justify-end space-x-4 w-full md:w-auto">
                   ...
                   <button 
                   @click="isCartOpen = !isCartOpen" class="relative p-2 text-gray-700 hover:text-pink-600" 
                   aria-label="Cart">
                   <Icon icon="mdi:cart-outline" class="w-5 h-5" />
                   <span class="absolute -top-1 -right-1 bg-pink-500 text-white text-xs rounded-full h-5 w-5 flex 
